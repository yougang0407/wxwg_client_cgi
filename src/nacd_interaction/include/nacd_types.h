...
#define NACD_HEART_BEAT_ERR			32
#define NACD_USER_PASSWD_AUTH_ERR	33
#define NACD_SEC_ASSERT_ADD_ERR		34
#define NACD_SEC_ASSERT_DEL_ERR		35
#define NACD_QUIT_ERR				36
